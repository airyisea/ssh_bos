		...
		<table class="easyui-datagrid" fit="true" nowrap="false">
			...
			<script type="text/javascript">
				function showData(taskId){
					$.post("${pageContext.request.contextPath}/process/task_showData",{"id":taskId},function(data){
			...
			<tbody>
				<s:iterator value="list" var="task">
					<tr>
						...
						<td>
							<s:a action="task_%{taskDefinitionKey}" namespace="/process" cssClass="easyui-linkbutton">办理任务
