  			...
  			<s:iterator value="list">
  				<tr>
  					...
  					<td>
  						...
  						<script type="text/javascript">
  							//根据流程实例id查询流程变量
  							$.post("${pageContext.request.contextPath}/process/processInstance_findData.action",{"id":'${id}'},function(data){
  								$("#div${id}").html(data);
  							});
  						</script>
  						<script type="text/javascript">
  							function viewpng(id){
  								url = "${pageContext.request.contextPath}/process/processInstance_viewpng?id="+id;
  								window.showModalDialog(url, "", "dialogWidth:1020px;dialogHeight:500px;help:no;resizable:no;center:yes;scroll:yes;status:no");  
  							}
  						</script>
  					</td>
  					<td>
  						<a onclick="viewpng('${id}');" href="#">查看流程图</a>
  					</td>
  				</tr>
  			</s:iterator>
  		</tbody>
